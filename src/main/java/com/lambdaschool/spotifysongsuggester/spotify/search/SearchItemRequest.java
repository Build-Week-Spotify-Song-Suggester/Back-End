package com.lambdaschool.spotifysongsuggester.spotify.search;
...
public class SearchItemRequest extends AbstractDataRequest {
	...
	/**
	 * The private {@link com.wrapper.spotify.requests.data.search.SearchItemRequest} constructor.
	 *
	 * @param builder A {@link com.wrapper.spotify.requests.data.search.SearchItemRequest.Builder}.
	 */
	...
	/**
	 * Builder class for building a {@link com.wrapper.spotify.requests.data.search.SearchItemRequest}.
	 */
	public static final class Builder extends AbstractDataRequest.Builder<Builder> {

		/**
		 * Create a new {@link com.wrapper.spotify.requests.data.search.SearchItemRequest.Builder}.
		 *
		 ...
		 * @return A {@link com.wrapper.spotify.requests.data.search.SearchItemRequest.Builder}.
		 ...
		 */
		@Override
		public com.wrapper.spotify.requests.data.search.SearchItemRequest build() {
			setPath("/v1/search");
			return new com.wrapper.spotify.requests.data.search.SearchItemRequest(this);
		}
	}
}