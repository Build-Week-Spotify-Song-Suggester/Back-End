...
public class SearchPlaylistsRequest extends AbstractDataRequest {
  /**
   * The private {@link com.wrapper.spotify.requests.data.search.simplified.SearchPlaylistsRequest} constructor.
   *
   * @param builder A {@link com.wrapper.spotify.requests.data.search.simplified.SearchPlaylistsRequest.Builder}.
   */
  ...
  /**
   * Builder class for building a {@link com.wrapper.spotify.requests.data.search.simplified.SearchPlaylistsRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<Builder> {

    /**
     * Create a new {@link com.wrapper.spotify.requests.data.search.simplified.SearchPlaylistsRequest.Builder}.
     *
     ...
     * @return A {@link com.wrapper.spotify.requests.data.search.simplified.SearchPlaylistsRequest.Builder}.
     ...
     */
    @Override
    public com.wrapper.spotify.requests.data.search.simplified.SearchPlaylistsRequest build() {
      setPath("/v1/search");
      setQueryParameter("type", "playlist");
      return new com.wrapper.spotify.requests.data.search.simplified.SearchPlaylistsRequest(this);
    }
  }
}
