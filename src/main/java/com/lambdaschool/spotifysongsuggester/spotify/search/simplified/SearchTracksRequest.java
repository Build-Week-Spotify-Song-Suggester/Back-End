...
public class SearchTracksRequest extends AbstractDataRequest {
	...
	/**
	 * The private {@link com.wrapper.spotify.requests.data.search.simplified.SearchTracksRequest} constructor.
	 *
	 * @param builder A {@link com.wrapper.spotify.requests.data.search.simplified.SearchTracksRequest.Builder}.
	 */
	...
	/**
	 * Builder class for building a {@link com.wrapper.spotify.requests.data.search.simplified.SearchTracksRequest}.
	 */
	public static final class Builder extends AbstractDataRequest.Builder<Builder> {

		/**
		 * Create a new {@link com.wrapper.spotify.requests.data.search.simplified.SearchTracksRequest.Builder}.
		 *
		 ...
		 * @return A {@link com.wrapper.spotify.requests.data.search.simplified.SearchTracksRequest.Builder}.
		 ...
		 */
		@Override
		public com.wrapper.spotify.requests.data.search.simplified.SearchTracksRequest build() {
			setPath("/v1/search");
			setQueryParameter("type", "track");
			return new com.wrapper.spotify.requests.data.search.simplified.SearchTracksRequest(this);
		}
	}
}