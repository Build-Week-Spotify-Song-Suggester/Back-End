...
public class SearchAlbumsRequest extends AbstractDataRequest {
  ...
  /**
   * The private {@link com.wrapper.spotify.requests.data.search.simplified.SearchAlbumsRequest} constructor.
   *
   * @param builder A {@link com.wrapper.spotify.requests.data.search.simplified.SearchAlbumsRequest.Builder}.
   */
  ...
  /**
   * Builder class for building a {@link com.wrapper.spotify.requests.data.search.simplified.SearchAlbumsRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<Builder> {

    /**
     * Create a new {@link com.wrapper.spotify.requests.data.search.simplified.SearchAlbumsRequest.Builder}.
     *
     ...
     * @return A {@link com.wrapper.spotify.requests.data.search.simplified.SearchAlbumsRequest.Builder}.
     ...
     */
    @Override
    public com.wrapper.spotify.requests.data.search.simplified.SearchAlbumsRequest build() {
      setPath("/v1/search");
      setQueryParameter("type", "album");
      return new com.wrapper.spotify.requests.data.search.simplified.SearchAlbumsRequest(this);
    }
  }
}
