...
public class SearchItemRequest extends AbstractDataRequest {
   ...
   */
  public SearchItemRequest(final Builder builder) {
    super(builder);
  }

  public SearchItemRequest(com.lambdaschool.spotifysongsuggester.spotify.search.SearchItemRequest.Builder builder)
  {
    super();
  }
