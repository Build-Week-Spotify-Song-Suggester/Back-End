...
public class SearchAlbumsRequest extends AbstractDataRequest {
   ...
   */
  public SearchAlbumsRequest(final Builder builder) {
    super(builder);
  }

  public SearchAlbumsRequest(com.lambdaschool.spotifysongsuggester.spotify.search.simplified.SearchAlbumsRequest.Builder builder)
  {
    super();
  }
