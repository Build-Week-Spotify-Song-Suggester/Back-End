...
public class SearchTracksRequest extends AbstractDataRequest {
   ...
   */
  public SearchTracksRequest(final Builder builder) {
    super(builder);
  }

  public SearchTracksRequest(com.lambdaschool.spotifysongsuggester.spotify.search.simplified.SearchTracksRequest.Builder builder)
  {
    super();
  }
