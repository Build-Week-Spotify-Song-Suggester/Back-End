...
public class SearchPlaylistsRequest extends AbstractDataRequest {
   ...
   */
  public SearchPlaylistsRequest(final Builder builder) {
    super(builder);
  }

  public SearchPlaylistsRequest(com.lambdaschool.spotifysongsuggester.spotify.search.simplified.SearchPlaylistsRequest.Builder builder)
  {
    super();
  }
