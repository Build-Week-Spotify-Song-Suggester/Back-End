...
public class SearchArtistsRequest extends AbstractDataRequest {
   ...
   */
  public SearchArtistsRequest(final Builder builder) {
    super(builder);
  }

	public SearchArtistsRequest(com.lambdaschool.spotifysongsuggester.spotify.search.simplified.SearchArtistsRequest.Builder builder)
	{
		super();
	}
