...
public class GetTrackRequest extends AbstractDataRequest {
   ...
   */
  public GetTrackRequest(final Builder builder) {
    super(builder);
  }

  public GetTrackRequest(com.lambdaschool.spotifysongsuggester.spotify.tracks.GetTrackRequest.Builder builder)
  {
  }
